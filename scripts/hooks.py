...
BASE_URL = "https://raw.githubusercontent.com/mozilla-ai/omni-llm/refs/heads/main/docs/"
ENCODING = "utf-8"
...
def get_provider_metadata(provider_dir):
    ...
    from omni_llm.provider import ProviderFactory
...
def generate_provider_table(providers):
    ...
    for provider in providers:
        ...
        source_url = f"https://github.com/mozilla-ai/omni-llm/tree/main/src/any_llm/providers/{provider_key}/"
...
def generate_llms_txt(docs_dir, site_dir, nav_config):
    ...
    llms_txt_content.append("# omni-llm")
...
def generate_llms_full_txt(docs_dir, site_dir, nav_config):
    ...
    llms_full_content.extend(
        [
            "# omni-llm Documentation",
            "",
            "> Complete documentation for omni-llm - A Python library providing a single interface to different llm providers.",
            "",
