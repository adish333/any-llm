...
try:
    ...
    msg = "mistralai is not installed. Please install it with `pip install omni-llm-sdk[mistral]`"
    ...
    def _stream_completion(
        ...
        **kwargs: Any,
        ...
        for event in mistral_stream:
            from omni_llm.providers.mistral.utils import _create_openai_chunk_from_mistral_chunk
