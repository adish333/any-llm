...
try:
    ...
    msg = "instructor is not installed. Please install it with `pip install omni-llm-sdk[sambanova]`"
...
from omni_llm.provider import convert_instructor_response
from omni_llm.providers.openai.base import BaseOpenAIProvider
