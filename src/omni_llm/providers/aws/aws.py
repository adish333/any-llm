...
try:
    ...
    msg = "boto3 or instructor is not installed. Please install it with `pip install omni-llm-sdk[aws]`"
    raise ImportError(msg)

from openai.types.chat.chat_completion import ChatCompletion
from omni_llm.provider import Provider, ApiConfig, convert_instructor_response
from omni_llm.exceptions import MissingApiKeyError, UnsupportedParameterError
from openai._streaming import Stream
from openai.types.chat.chat_completion_chunk import ChatCompletionChunk
from omni_llm.providers.aws.utils import _convert_response, _convert_kwargs, _convert_messages
