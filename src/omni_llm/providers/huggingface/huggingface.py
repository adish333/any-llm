...
try:
    ...
    msg = "huggingface-hub is not installed. Please install it with `pip install omni-llm-sdk[huggingface]`"
...
from omni_llm.providers.huggingface.utils import _convert_pydantic_to_huggingface_json
