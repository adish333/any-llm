...
try:
    ...
    msg = "ibm-watsonx-ai is not installed. Please install it with `pip install omni-llm-sdk[watsonx]`"
...
from omni_llm.providers.watsonx.utils import _convert_response
