...
try:
    ...
    msg = "anthropic or instructor is not installed. Please install it with `pip install omni-llm-sdk[anthropic]`"
...
from omni_llm.provider import Provider, convert_instructor_response
from omni_llm.providers.anthropic.utils import (
